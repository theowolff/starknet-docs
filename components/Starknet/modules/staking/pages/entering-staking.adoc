...
* Sufficient STRK token balance in your wallet (Note: Ledger hardware wallet is supported through link:https://www.argent.xyz/blog/how-to-use-your-hardware-wallet-with-argent/[Argent] or link:https://braavos.app/wallet-features/ledger-on-braavos/[Braavos])
